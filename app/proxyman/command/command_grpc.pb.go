...
type HandlerServiceClient interface {
	GetAllInbounds(ctx context.Context, in *GetAllInboundsRequest, opts ...grpc.CallOption) (*GetAllInboundsResponse, error)
...
func (c *handlerServiceClient) GetAllInbounds(ctx context.Context, in *GetAllInboundsRequest, opts ...grpc.CallOption) (*GetAllInboundsResponse, error) {
	out := new(GetAllInboundsResponse)
	err := c.cc.Invoke(ctx, "/xray.app.proxyman.command.HandlerService/GetAllInbounds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *handlerServiceClient) GetAllOutbounds(ctx context.Context, in *GetAllOutboundsRequest, opts ...grpc.CallOption) (*GetAllOutboundsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xray.app.proxyman.command.HandlerService/GetAllOutbounds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HandlerServiceServer interface {
	GetAllInbounds(context.Context, *GetAllInboundsRequest) (*GetAllInboundsResponse, error)
...
func (UnimplementedHandlerServiceServer) GetAllInbounds(context.Context, *GetAllInboundsRequest) (*GetAllInboundsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllInbounds not implemented")
}
...
func _HandlerService_GetAllInbounds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllInboundsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServiceServer).GetAllInbounds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xray.app.proxyman.command.HandlerService/GetAllInbounds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServiceServer).GetAllInbounds(ctx, req.(*GetAllInboundsRequest))
	}
...
func _HandlerService_GetAllOutbounds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(HandlerServiceServer).GetAllOutbounds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xray.app.proxyman.command.HandlerService/GetAllOutbounds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServiceServer).GetAllOutbounds(ctx, req.(*GetAllOutboundsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HandlerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetAllInbounds",
			Handler:    _HandlerService_GetAllInbounds_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _HandlerService_GetAllOutbounds_Handler,
		},
		{
