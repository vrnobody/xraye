...
const file_app_router_command_command_proto_rawDesc = "" +
	...
	"\rPublishResult\x18\x03 \x01(\bR\rPublishResult\"S\n" +
	"\x17SetRoutingConfigRequest\x128\n" +
	"\x06config\x18\x01 \x01(\v2 .xray.common.serial.TypedMessageR\x06config\"\x1a\n" +
	"\x18SetRoutingConfigResponse\"\x19\n" +
	"\x17GetRoutingConfigRequest\"T\n" +
	"\x18GetRoutingConfigResponse\x128\n" +
	"\x06config\x18\x01 \x01(\v2 .xray.common.serial.TypedMessageR\x06config\"'\n" +
	...
	"\x1eOverrideBalancerTargetResponse\"\b\n" +
	"\x06Config2\xec\x05\n" +
	"\x0eRoutingService\x12y\n" +
	"\x10SetRoutingConfig\x120.xray.app.router.command.SetRoutingConfigRequest\x1a1.xray.app.router.command.SetRoutingConfigResponse\"\x00\x12y\n" +
	"\x10GetRoutingConfig\x120.xray.app.router.command.GetRoutingConfigRequest\x1a1.xray.app.router.command.GetRoutingConfigResponse\"\x00\x12{\n" +
	...
	"\x16OverrideBalancerTarget\x126.xray.app.router.command.OverrideBalancerTargetRequest\x1a7.xray.app.router.command.OverrideBalancerTargetResponse\"\x00Bg\n" +
