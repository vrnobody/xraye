...
type RoutingServiceClient interface {
	SetRoutingConfig(ctx context.Context, in *SetRoutingConfigRequest, opts ...grpc.CallOption) (*SetRoutingConfigResponse, error)
	GetRoutingConfig(ctx context.Context, in *GetRoutingConfigRequest, opts ...grpc.CallOption) (*GetRoutingConfigResponse, error)
...
func (c *routingServiceClient) SetRoutingConfig(ctx context.Context, in *SetRoutingConfigRequest, opts ...grpc.CallOption) (*SetRoutingConfigResponse, error) {
	out := new(SetRoutingConfigResponse)
	err := c.cc.Invoke(ctx, "/xray.app.router.command.RoutingService/SetRoutingConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingServiceClient) GetRoutingConfig(ctx context.Context, in *GetRoutingConfigRequest, opts ...grpc.CallOption) (*GetRoutingConfigResponse, error) {
	out := new(GetRoutingConfigResponse)
	err := c.cc.Invoke(ctx, "/xray.app.router.command.RoutingService/GetRoutingConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingServiceClient) GetBalancerInfo(ctx context.Context, in *GetBalancerInfoRequest, opts ...grpc.CallOption) (*GetBalancerInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xray.app.router.command.RoutingService/GetBalancerInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingServiceClient) OverrideBalancerTarget(ctx context.Context, in *OverrideBalancerTargetRequest, opts ...grpc.CallOption) (*OverrideBalancerTargetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xray.app.router.command.RoutingService/OverrideBalancerTarget", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoutingServiceServer interface {
	SetRoutingConfig(context.Context, *SetRoutingConfigRequest) (*SetRoutingConfigResponse, error)
	GetRoutingConfig(context.Context, *GetRoutingConfigRequest) (*GetRoutingConfigResponse, error)
...
func (UnimplementedRoutingServiceServer) SetRoutingConfig(context.Context, *SetRoutingConfigRequest) (*SetRoutingConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetRoutingConfig not implemented")
}
func (UnimplementedRoutingServiceServer) GetRoutingConfig(context.Context, *GetRoutingConfigRequest) (*GetRoutingConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRoutingConfig not implemented")
}
...
func _RoutingService_SetRoutingConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetRoutingConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingServiceServer).SetRoutingConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xray.app.router.command.RoutingService/SetRoutingConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingServiceServer).SetRoutingConfig(ctx, req.(*SetRoutingConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RoutingService_GetRoutingConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRoutingConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingServiceServer).GetRoutingConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xray.app.router.command.RoutingService/GetRoutingConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingServiceServer).GetRoutingConfig(ctx, req.(*GetRoutingConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RoutingService_GetBalancerInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xray.app.router.command.RoutingService/GetBalancerInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RoutingService_OverrideBalancerTarget_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xray.app.router.command.RoutingService/OverrideBalancerTarget",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RoutingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SetRoutingConfig",
			Handler:    _RoutingService_SetRoutingConfig_Handler,
		},
		{
			MethodName: "GetRoutingConfig",
			Handler:    _RoutingService_GetRoutingConfig_Handler,
		},
		{
