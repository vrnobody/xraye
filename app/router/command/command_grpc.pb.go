...
const (
	RoutingService_SetRoutingConfig_FullMethodName       = "/xray.app.router.command.RoutingService/SetRoutingConfig"
	RoutingService_GetRoutingConfig_FullMethodName       = "/xray.app.router.command.RoutingService/GetRoutingConfig"
...
func (c *routingServiceClient) SetRoutingConfig(ctx context.Context, in *SetRoutingConfigRequest, opts ...grpc.CallOption) (*SetRoutingConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, RoutingService_SetRoutingConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingServiceClient) GetRoutingConfig(ctx context.Context, in *GetRoutingConfigRequest, opts ...grpc.CallOption) (*GetRoutingConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, RoutingService_GetRoutingConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RoutingService_SetRoutingConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingService_SetRoutingConfig_FullMethodName,
	}
...
func _RoutingService_GetRoutingConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingService_GetRoutingConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
