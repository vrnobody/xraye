...
func (UnimplementedRoutingServiceServer) SetRoutingConfig(context.Context, *SetRoutingConfigRequest) (*SetRoutingConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetRoutingConfig not implemented")
}
func (UnimplementedRoutingServiceServer) GetRoutingConfig(context.Context, *GetRoutingConfigRequest) (*GetRoutingConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRoutingConfig not implemented")
}
